...
public class IzvjestajORangListiKlubova extends JFrame {
	...
	public IzvjestajORangListiKlubova() {
		...
		txtpnIzvjetajORang.setText("Izvje\u0161taj o rang listi klubova");
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(txtpnIzvjetajORang, GroupLayout.PREFERRED_SIZE, 156, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(txtpnDatumIVrijeme, GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
